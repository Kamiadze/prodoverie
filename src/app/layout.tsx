                ...
                <div className="flex items-center justify-between h-20">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-10 flex items-baseline space-x-6">
                      <a href="/" className="px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-light hover:text-warm transition-colors">Главная</a>
                      <a href="/services" className="px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-light hover:text-warm transition-colors">Услуги</a>
                      <a href="/booking" className="px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-light hover:text-warm transition-colors">Бронирование</a>
                      <a href="/contacts" className="px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-light hover:text-warm transition-colors">Контакты</a>
                    </div>
                  </div>
                </div>
              </div>
